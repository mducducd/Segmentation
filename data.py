...
class MyDataset(data.Dataset):
    ...
    def pull_item(self, index):
        ...
        anno_class_img = Image.open(anno_file_path) # PIL -> (h, w, channel{RGB})
...
if __name__ == "__main__":
    ...
    # print("val_dataset_img: {}".format(val_dataset_img.__getitem__(0)[0].shape))
    # print("val_dataset_anno_class_img: {}".format(val_dataset_img.__getitem__(0)[1].shape))
    # print("val_dataset_: {}".format(val_dataset_img.__getitem__(0)))
